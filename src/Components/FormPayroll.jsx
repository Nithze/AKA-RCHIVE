...
const FormEmployee = ({ isOpen, onClose }) => {
	...
	const [deductions, setDeductions] = useState([
		{ title: "deductionPerAlpha", amount: "" },
	]);
	const [bonuses, setBonuses] = useState([{ title: "", amount: "" }]);
	const [employees, setEmployees] = useState([]);
	...
	const handleSave = async () => {
		...
		try {
			const response = await fetch(
				"http://localhost:5000/api/payroll/payroll",
				{
					method: "POST",
				...
				<div className="add-employee">
					...
					<div className="form-container">
						<div className="form-left">
							<div className="form-group">
								<label>
									Select Employee<span className="warning-text">*</span>
								</label>
								<select
									name="employee"
									required
							...
							<div className="form-group">
								<label>
									Potongan<span className="warning-text">*</span>
								</label>
						...
						<div className="form-right">
							<div className="form-group">
								<label>
									Tahun Bulan<span className="warning-text">*</span>
								</label>
								<input
									type="text"
									placeholder="YYYY-M"
							...
							<div className="form-group">
								<label>
									Bonus<span className="warning-text">*</span>
								</label>
								<div className="multi-input">
									{bonuses.map((bonus, index) => (
										<div className="bonus-item" key={index}>
