...
//                                         <input className='inputz' type="text" placeholder='Bonus Title' />
//                                         <input className='inputx' type="text" placeholder='300000' />
//                                     </div>
//                                 </div>
//                                 <div className="input-action">
//                                     <button className='btn-input-w'>-</button>
...
//                                         }
//                                         e.target.value = value; // Set nilai input
//                                     }}
//                                     required
//                                 />
//                             </div>
