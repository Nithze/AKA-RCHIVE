                ...
                <div style={{
                    ...
                    <div id="payroll-modal-content" style={{
                        ...
                        <div style={{ marginBottom: '' }}>
                            ...
                            {/*         </p> */}
                            {/*         <p style={{ fontSize: '16px', fontWeight: 'bold', color: '#00ff00' }}> */}
                            {/*             {`${selectedPayroll.basicSalary.toLocaleString()} + ${selectedPayroll.bonuses.reduce((total, bonus) => total + bonus.amount, 0).toLocaleString()} - ${selectedPayroll.deductions.reduce((total, deduction) => total + deduction.amount, 0).toLocaleString()} = ${selectedPayroll.netSalary.toLocaleString()}`} */}
                            {/*         </p> */}
                            {/*     </div> */}
                            {/* </div> */}
                            <div style={{ display: 'flex', justifyContent: 'space-between', paddingTop: '10px', borderTop: '2px solid #222' }}>
